...
import { SectionFormDialog } from "@/courseSections/components/SectionFormDialog";
import { Button } from "@/components/ui/button";
import { SortableSectionList } from "@/courseSections/components/SortableSectionList";
import { getCourseSectionCourseTag } from "@/courseSections/db/cache";
...
export default async function CourseEditPage({
 ...
 const course = await getCourse(courseId.courseId);
